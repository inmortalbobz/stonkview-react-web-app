...
export const register = async (user) => {
    const response = await api.post(`${BASE_URL}/gold-register`, user)
...
export const updateGoldUser = async (profile) => {
    const response = await axios.put(`${BASE_URL}/users/gold`, profile)
    return response.data
}